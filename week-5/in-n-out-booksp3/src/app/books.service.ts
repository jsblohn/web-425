...
; Book Service for in-n-out-booksp3 app
============================================
*/
  ...
  constructor() {
    ...
    this.books = [
      ...
      },
      {
        ...
        description: 'The prequel to "To Kill a Mockingbird". It is about the same characters 20 years later. Scout returns home, bringing back memories of the racism that exists in her hometown.',
        numOfPages: 288,
        authors: ['Harper Lee']
      },
      {
